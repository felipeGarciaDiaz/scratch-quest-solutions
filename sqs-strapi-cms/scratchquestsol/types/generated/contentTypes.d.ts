...
export interface ApiSiteContentSiteContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    features_icon: Schema.Attribute.String;
...
export interface ApiSiteSubtitleSiteSubtitle extends Struct.SingleTypeSchema {
  collectionName: 'site_subtitles';
  info: {
    description: '';
    displayName: 'Site Content';
    pluralName: 'site-subtitles';
    singularName: 'site-subtitle';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::site-subtitle.site-subtitle'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtitle_html: Schema.Attribute.Blocks;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::site-subtitle.site-subtitle': ApiSiteSubtitleSiteSubtitle;
